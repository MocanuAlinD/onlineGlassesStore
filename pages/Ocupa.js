    ...
    <div className={styles.ocupaContainer + " m-0 p-0 px-3 py-5"}>
      <div className={styles.ocupaUnu}>
        ...
        <ul>
          ...
          <li>
            Consulatii oftalmologice in vederea determinarii de dioptrii
            -GRATUIT
          </li>
          <li>
            Consultatiile sunt efectuate de catre specialisti in domeniu cu
            aparatura performanta
          </li>
          <li>
            Mini – training de informare cu privire la tipul de protectie
            necesara pentru ochi ( in functie de domeniul de activitate)
            –GRATUIT
          </li>
          <li>
            Punem la dispozitia angajatilor o GAMA VARIATA de rame (diverse
            modele)
          </li>
          <li>
            Oferim tratamente oculare/ Ochelari de protectie cu dioptrii/
            Ochelari de vedere sau de soare cu/fara dioptrii si lentile de
            contact.
          </li>
          <li>
            Algerea unui model de rama optim la recomandarea si cu sprijinul
            consultantului nostru;
          </li>
          <li>Montajul lentilelor pe rama aleasa - GRATUIT</li>
          <li>
            Livrarea ochelarilor in cel mai scurt timp sau la un termen stabilit
            de comun acord.
          </li>
          <li>
            Acordarea serviciilor in regim de urgenta salariatilor care prezinta
            cazuri speciale de dioptrii, sau care isi motiveaza urgenta -
            GRATUIT
          </li>
          <li>
            Oferim tocuri, lavete, snururi. pentru comenzile complete de
            ochelari ( rama si lentile ) - GRATUIT
          </li>
      ...
      <div className={styles.ocupaDoi}>
        ...
        <ul>
          ...
          <li>
            Posibilitatea achitarii ochelarilor in 2/3 rate (in functie de
            valoarea produsului achizitionat)
          </li>
          <li>Fara dobanzi sau comisioane suplimentare</li>
          <li>
            Este necesara plata unui avans de 15-20% in functie de valoare
      ...
      <div className={styles.ocupaTrei}>
        ...
        <ul>
          ...
          <li>
            Cu fiecare an de colaborare, discount-ul acordat angajatilor va
            creste conform acordului agreat.
          </li>
        </ul>
      </div>
      <div className={styles.ocupaPatru}>
        ...
        <ul>
          <li>
            Lentile pentru corectarea vederii (monofocale, bifocale, progresive
            )
          </li>
